...
/**
 * A directive for managing all users in the connection group.
 */
angular.module('settings').directive('guacConnectionUsers', [function guacConnectionUsers() {
    ...
    return {
        ...
        templateUrl: 'app/ext/guac-custom/html/assign-connection-group.html',
        controller: ['$scope', '$injector', function settingsUsersController($scope, $injector) {
            ...
            $scope.connectionGroupUserPermissionChanged = function connectionGroupUserPermissionChanged(identifier) {
	            var granted = $scope.selectedUserFlag[identifier];
	            if (granted)
	            	removeConnectionGroupUserPermission(identifier);
	            else
	            	addConnectionGroupUserPermission(identifier);
	        };	
            var addConnectionGroupUserPermission = function addConnectionGroupUserPermission(identifier) {
                if ($scope.selectedUserFlag[identifier].indexOf(type) !== -1)
                	$scope.selectedUserFlag.splice(identifier,1);
                else
            ...
            var removeConnectionGroupUserPermission = function removeConnectionGroupUserPermission(identifier) {
            	debugger;
...
//                    PermissionSet.addConnectionGroupPermission(permissionsRemoved, PermissionSet.ObjectPermissionType.READ, identifier);
            ...
            $scope.saveConnectionGroupUsers = function saveConnectionGroupUsers() {
            	debugger;
            };
