...
/**
 * A directive which displays the contents of a custom connection group within an
 * automatically-paginated view.
 */
angular.module('groupList').directive('guacCustomGroupList', [function guacCustomGroupList() {
    ...
    return {
        ...
        templateUrl: 'app/ext/guac-custom/html/guacCustomGroupList.html',
