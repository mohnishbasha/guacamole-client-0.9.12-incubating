...
angular.module('rest').factory('connectionGroupService', ['$injector',
  ...
  service.getConnectionGroupUsers = function getConnectionGroup(dataSource, connectionGroupID) {
        ...
        return $http({
            cache   : cacheService.connections,
            method  : 'GET',
            url     : 'api/session/data/' + encodeURIComponent(dataSource) + '/connectionGroups/' + encodeURIComponent(connectionGroupID)+"/assign",
            params  : httpParameters
        });
     ...
     */
    service.saveConnectionGroup = function saveConnectionGroup(dataSource, connectionGroup, connectionGroupUser) {
        ...
        if (!connectionGroup.identifier) {        	
            ...
            .success(function connectionGroupCreated(newConnectionGroup){
           	 ...
           	 $http({
                    method  : 'PUT',
                    url     : 'api/session/data/' + encodeURIComponent(dataSource) + '/connectionGroups/'+ connectionGroup.identifier +'/assign',  
                    params  : httpParameters,
                    data    : connectionGroupUser
                }).success(function savedConnectionGroupUsers() {
